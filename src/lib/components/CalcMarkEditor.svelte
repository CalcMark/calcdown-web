...
<div class="container">
	...
	<div class="editor-grid">
		<div class="demo-section">
			...
			<textarea class="source-input" bind:value={input} oninput={handleInput} spellcheck="false"
			></textarea>
		</div>

		<div class="demo-section">
			<h2>Syntax Highlighted Output</h2>
			<div class="highlighter-wrapper" onmouseover={handleMouseOver} onmouseout={handleMouseOut}>
				<SyntaxHighlighter
					{input}
					{tokensByLine}
					{lineClassifications}
	...
	<ValueTooltip visible={tooltipVisible} text={tooltipText} x={tooltipX} y={tooltipY} />
	...
	<div class="details-container">
		...
		<div class="demo-section compact">
			<TokenizationDetails {tokensByLine} />
		</div>
	</div>
</div>
